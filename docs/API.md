...
- `POST /api/appointments/recommend` uses non-AI scheduling logic based on working hours and appointment conflicts. Travel time is a placeholder for future route planning.
